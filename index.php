...
<body class="bg-light">
  ...
  <header class="sticky-top">
    <div class="gradient-01 pb-4">
      <div class="row m-0 d-flex align-items-center justify-content-between justify-content-md-center gap-5">

        <div class="d-none col-auto d-md-flex justify-content-center align-items-center gap-5 pt-3 pb-3 ps-lg-4 pe-lg-4 bg-light boxShadow-01 rounded-3 ">
          <button class="navItem btn btn-light rounded-3" type="button">
             <img height="40px" width="auto" src="<?php echo get_template_directory_uri();?>/assets/img/asignet-logo.png" alt="Asignet logo">
          </button>
          <button class="navItem btn btn-light rounded-3" type="button">Product</button>
          ...
          <button class="navItem btn btn-secondary rounded-3" type="button">Request a demo</button>
        </div>
        
        <div class="d-md-none d-flex justify-content-end">
          <button class="btn btn-light boxShadow-01 rounded-3 " type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasHeader" aria-controls="offcanvasHeader">
    ...
    <div class="row d-flex justify-content-center w-100">
      <div class="col-10">
        ...
        <div id="carouselOne" class="carousel slide mt-3" data-bs-ride="carousel">
          <div class="boxShadow-01 carousel-inner">
            <div class="carousel-item active">
              <img src="<?php echo get_template_directory_uri();?>/assets/img/dog.webp" class="d-block rounded w-100" />
              <div class="card-img-overlay">
                <p class="card-title shadow fs-4 fw-bold p-2 p-sm-3">Cut Cost Feature.</p>
                <p class="card-text d-none fs-5 d-md-block p-3"></p>
              </div>
            </div>
            <div class="carousel-item">
              <img src="<?php echo get_template_directory_uri();?>/assets/img/dog.webp" class="d-block rounded w-100" />
              <div class="card-img-overlay t-black">
                <p class="card-title mainTitle shadow fs-4 fw-bold p-2 p-sm-3">Manage Payments Feature.</p>
                <p class="card-text d-none fs-5 d-md-block p-3"></p>
              </div>
            </div>
            <div class="carousel-item">
              <img src="<?php echo get_template_directory_uri();?>/assets/img/dog.webp" class="d-block rounded w-100" />
              <div class="card-img-overlay">
                <p class="card-title shadow fs-4 fw-bold p-2 p-sm-3">Wayfast Feature.</p>
                <p class="card-text d-none fs-5 d-md-block p-3"></p>
              </div>
            </div>
          </div>
